...
const routes: Routes = [
  {path: 'login', component: LoginComponent},
  {
    ...
    children: [
      ...
      {path: 'products/inventory', component: ProductInventoryComponent},
      {path: 'products/inventorytable', component: ProductInventoryTableComponent},
      {path: 'products/order', component: ProductOrderComponent},
      {path: 'products/order/:id', component: ProductOrderComponent},
      {path: 'products/ordertable', component: ProductOrderTableComponent},
      {path: 'products/ordersub', component: ProductorderSubFormComponent},
