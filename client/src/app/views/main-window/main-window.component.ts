...
export class MainWindowComponent implements OnInit, OnDestroy {
  ...
  private setLinkItems(): void{
    ...
    productLink.children.push(showAllProductLink);
     ...
     const ProductInventoryLink = new LinkItem('Add New Product In Inventory', 'products/inventory', 'add');
        showAllProductLink.addUsecaseId(UsecaseList.ADD_PRODUCT_INVENTORY);
        productLink.children.push(ProductInventoryLink);

        const ProductOrderLink = new LinkItem('Order Products', 'products/order', 'add');
